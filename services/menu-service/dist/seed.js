...
async function seed() {
    ...
    const menuConn = await mongoose_1.default.createConnection(MENU_URI).asPromise();
    ...
    const authConn = await mongoose_1.default.createConnection(AUTH_URI).asPromise();
    ...
    const inventoryConn = await mongoose_1.default.createConnection(INVENTORY_URI).asPromise();
    ...
    const loyaltyConn = await mongoose_1.default.createConnection(LOYALTY_URI).asPromise();
    const LoyaltySchema = new mongoose_1.default.Schema({
    ...
    const notificationConn = await mongoose_1.default.createConnection(NOTIFICATION_URI).asPromise();
